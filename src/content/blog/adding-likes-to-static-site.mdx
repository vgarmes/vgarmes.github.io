...
Since I wanted to give the possibility to like the posts without the need of creating an account and being authenticated, I identify the users using the origin IP address in the request. However, in order to not keep senstive data I hash the ip.
