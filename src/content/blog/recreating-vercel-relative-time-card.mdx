---
title: "Recreating Vercel's Relative Time Card component"
pubDate: 2025-03-10
description: 'In this article, we walk through how to build a Relative Time Card component similar to Vercel’s, using native JavaScript APIs to format date differences and handle time zones.'
image:
  url: ''
...
To render this on hover, we can just leverage [Radix's Hover Card](https://www.radix-ui.com/primitives/docs/components/hover-card).
